...
var questions = [{
    ...
    question: "String values must be enclosed within ____ when being assigned to a variable.",
    a: "Commas",
    b: "Curly brackets",
    c: "Qouts",
    d: "parenthesis",
...
function mainPageContent() {
    ...
    quizeHeader.textContent = "Coding Quiz Challenge";
    ...
    startQuizeBtn.textContent = "Start Quiz";
